...
| [007](007-synthetic-error-localization/) | Can current Vosk scoring and kana highlighting locate controlled errors across 20 prompted voices and environmental interference? | Pipeline passed; localization failed precision gate | Across 1,760 synthetic attempts, position recall was 0.918 but precision was only 0.113; all 440 exact controls were falsely marked, and 95.8% of deliberate errors were accepted by the coarse sentence gate. |
