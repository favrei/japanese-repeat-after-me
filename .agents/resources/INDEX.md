...
External references, tutorials, reusable code snippets, and research notes
belong here.

For every added resource, record:

- a short descriptive title;
- the source or URL;
- why it matters to this project;
- the date accessed when the source may change;
- any license or redistribution constraint.
...
- [`seinen-manga-frame/`](seinen-manga-frame/README.md) — self-contained static
  ...
  screentone technique. Design reference for the `app/` frame port; not
